...
5. **Create the tickets, confirm-first.** *"In the Playground project, create an Epic from the proposal and a Story per behavior with its 'Why', plus sub-tasks. Show me the tree first."* — read it, then say **"go."**
